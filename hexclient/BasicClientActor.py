...
if __name__ ==  '__main__':
    ...
    #model = network.HEX_CNN(name="HEX-CNN",dim=5,filepath="../models/CNN-15000/CNN-15000_1000")
    model = network.HEX_CNN(name="HEX-CNN",dim=5,filepath="../models/CNN-20000-3/CNN-20000-3_1000")

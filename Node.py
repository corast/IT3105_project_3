...
class Node():
    ...
    def rollout_policy_network(self, rollout_state,  anet:Model, greedy): # TODO: high probability for random to begin with.
        #TODO: Fix inputs...
    ...
    def rollout(self, root_player, anet=None, greedy=False, epsilon=None): # How we traverse the rest of the tree to terminal
